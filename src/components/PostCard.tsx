    ...
    <Card className='w-full relative'>
        <CardHeader>
           <div className="flex justify-between">
             <div className="flex lg:flex-row md:flex-row flex-col items gap-2 ">
                  <div>
        ...
        <CardContent className="divide-y divide-dashed">
          <CardDescription className='pb-2'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum reprehenderit dolore animi distinctio quibusdam debitis eum omnis pariatur. Blanditiis, obcaecati?</CardDescription>
        </CardContent>
      </Card>
  )
}
